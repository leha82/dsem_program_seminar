...
//	private JButton btnChallenge;
	...
	public MazeEscapeChallenge(BaseModule bm, ChallengeInfo ci) {
		super(appTitle);
...
//		System.out.println(bm.getMapWidth() + "," + bm.getMapHeight());
		...
		btnSearch.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				PlayThread playThread = new PlayThread(bm, ci, 0);
				
				SearchTimerActionListener stal = new SearchTimerActionListener(timeThread, playThread);
				Timer playTimer = new Timer (ci.getDelayShow(), stal);
				stal.setTimer(playTimer);
...
//				System.out.println("challenge time : " + ci.getChallengeTime());
	...
	public static void main(String[] args) {
		...
		MazeEscapeChallenge mec = new MazeEscapeChallenge(bm, ci);
